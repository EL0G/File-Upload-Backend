...
class UserManager(UUIDIDMixin, BaseUserManager[User, uuid.UUID]):
    ...
    async def on_after_register(self, user: User, request: Optional[Request] | None = None) -> None:
    ...
    async def on_after_request_verify(self, user: User, token: str, request: Optional[Request] | None = None) -> None:
